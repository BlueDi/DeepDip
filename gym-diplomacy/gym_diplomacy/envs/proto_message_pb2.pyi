...
class DiplomacyGymResponse(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"deal"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"deal",u"type"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"deal",b"deal"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"deal",b"type"]) -> None: ...
