...
BandanaRequest = _reflection.GeneratedProtocolMessageType('BandanaRequest', (_message.Message,), dict(
  ...
  __module__ = 'gym_diplomacy.envs.proto_message_pb2'
